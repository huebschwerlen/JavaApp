...
//    }
    ...
    if (args.length == 0) {
      printErrorMessageAndExitWithUsage("Missing Command Line Arguments");
    }
    ...
    if (args.length >= 6 && args.length <= 9) {
      ...
      if (args.length == 6 && !args[0].equalsIgnoreCase("-print")) {
        ...
        if (validDateTime6) {
          ...
          //if (validDateTime6)
          printErrorMessageAndExitWithUsage("Invalid Arguments if (validDateTime6)");
        }
      }
...
//        System.out.println("AptBook Empty: " + aptBook.getAppointments().isEmpty());
          ...
          //if (validDateTime7)
          printErrorMessageAndExitWithUsage("Invalid Arguments if (validDateTime7)");
        }
      }


      else if (args.length == 8 && args[0].equalsIgnoreCase("-textfile")) {
...
//        System.out.println("AptBook Empty: " + aptBook.getAppointments().isEmpty());
          ...
          if (!file.contains(".")) {
            printErrorMessageAndExitWithOutUsage("Please make sure to include file extension with file name.\n"+
...
//              System.out.println("\nFile " + file + " WAS FOUND\n");
            ...
            System.err.println("\nFILE " + file + " Not Found\nCreating file: " + file +
                    " in /Users/sam/Desktop/PortlandStateJavaSummer2021/apptbook/src/main/resources/edu/pdx/cs410J/hueb\n");
...
//                System.out.println("SAME!!!");
                ...
                System.out.println("Filepaths Do Not Match" + "\nfp1: " + t1 + "\nfp2: " + t2);
              }
              fi.createNewFile();
            } catch (IOException e) {
              System.err.println("Create file for 9 args failed");
              e.printStackTrace();
            }
            //dump aptBook to file
            try {
          ...
          //if (validDateTime8)
          printErrorMessageAndExitWithUsage("Invalid Arguments if (validDateTime8)");
        }
...
//                  System.out.println("SAME!!!");
                  ...
                  System.out.println("Filepaths Are Not the Same" + "\nfp1: " + t1 + "\nfp2: " + t2);
                }
                fi.createNewFile();
              } catch (IOException e) {
                System.err.println("Create file for 9 args failed");
            ...
            //if (validDateTime9)
            printErrorMessageAndExitWithUsage("Invalid Arguments if (validDateTime9)");
          }
          ...
          printErrorMessageAndExitWithUsage("Invalid Arguments, 9 args, but missing -print and/or -textfile file");
        }
    ...
    //if (args.length >= 6 && args.length <= 9)
      ...
      //if (args.length >= 6 && args.length <= 9)
      printErrorMessageAndExitWithUsage("Invalid Arguments if (args.length >= 6 && args.length <= 7)");
    }
