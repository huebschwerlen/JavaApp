...
class Project3IT extends InvokeMainTestCase {
    ...
    void testWorkingWithPrint() {
        MainMethodResult result = invokeMain(Project3.class, "-pRiNt", "Brian Griffin", "Go play some golf", "7/15/2021", "14:39", "06/2/2021", "1:03");
    ...
    void testWorkingWithNoPrint() {
        MainMethodResult result = invokeMain(Project3.class, "Brian Griffin", "Go play some golf", "7/15/2021", "14:39", "06/2/2021", "1:03");
        assertThat(result.getExitCode(), equalTo(0));
    }
    ...
    void testIncorrectArgs3() {
        MainMethodResult result = invokeMain(Project3.class, "-pRiNt", "-filetext", "file", "Brian Griffin", "Go play some golf", "07/15/2021", "4:39", "06/2/2021", "1:03", "help", "jerry");
        String message = "Invalid Arguments";
        assertThat(result.getTextWrittenToStandardError(), CoreMatchers.containsString(message));
        assertThat(result.getExitCode(), equalTo(1));
    }
    ...
    void testcorrectArgsNoFileExt() {
        MainMethodResult result = invokeMain(Project3.class, "-pRiNt", "-textfile", "file", "Brian Griffin", "Go play some golf", "07/15/2021", "4:39", "06/2/2021", "1:03");
    ...
    void testcorrectArgsWithFileExt() {
        MainMethodResult result = invokeMain(Project3.class, "-pRiNt", "-textfile", "testFileP2.txt", "Brian Griffin", "Go play some golf", "07/15/2021", "4:39", "06/2/2021", "1:03");
        String message = "golf";
    ...
    void testcorrectArgs() {
        MainMethodResult result = invokeMain(Project3.class, "-pRiNt", "-textfile", "testFileP2.txt", "Buffy Summers", "Slay Vampires","12/11/1985","12:11","12/11/1986","12:12");
    ...
    void testcorrectArgs3() {
        MainMethodResult result = invokeMain(Project3.class, "-textfile", "testFileP2.txt", "-print", "Buffy Summers", "Slay Vampires","12/11/1985","12:11","12/11/1986","12:12");
        String message = "Slay Vampires";
        assertThat(result.getTextWrittenToStandardOut(), CoreMatchers.containsString(message));
        assertThat(result.getExitCode(), equalTo(0));
    }
    ...
    void testcorrectArg4() {
        MainMethodResult result = invokeMain(Project3.class, "-textfile", "testFileP2.txt", "Buffy Summers", "Slay Vampires","12/11/1985","12:11","12/11/1986","12:12");
        String message = "";
        assertThat(result.getTextWrittenToStandardError(), CoreMatchers.containsString(message));
